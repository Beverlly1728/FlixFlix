package id.example.shashank.flixflix.Adapter;
...
import id.example.shashank.flixflix.Activity.DetailActivity;
import id.example.shashank.flixflix.R;

public class FilmListAdapter extends RecyclerView.Adapter<FilmListAdapter.ViewHolder> {
    id.example.shashank.flixflix.Domain.ListFilm items;
    Context context;

    public FilmListAdapter(id.example.shashank.flixflix.Domain.ListFilm items) {
        this.items = items;
    }
